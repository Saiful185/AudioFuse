...
![AudioFuse Architecture Diagram](figures/AudioFuse_Architecture.png)  
*(Please replace `figures/AudioFuse_Architecture.png` with the path to your own model diagram)*
